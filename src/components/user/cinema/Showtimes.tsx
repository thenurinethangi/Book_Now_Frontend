                        ...
                        <div>
                            ...
                            <div className='flex items-center flex-wrap gap-3.5 mt-4'>
                                {showtimesOfSingleMovie.map((showtime: any) => (
                                    <div key={showtime._id} onClick={handleNavigateToBookingPage} data-id={showtime._id} className='w-[310px] h-[79px] border-l-4 border-l-[#cd242c] rounded-sm bg-[#2c2c2c] px-2.5 py-2.5 cursor-pointer hover:bg-[#3a3a3a] transition-all duration-400'>
