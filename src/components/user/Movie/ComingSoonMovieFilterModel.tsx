...
const ComingSoonMovieFilterModel = (props: any) => {
    ...
    function handleCloseFilterModel() {
        setIsVisible(false);
        setTimeout(() => props.setShowComingSoonFiltersModel(false), 150);
    }
    ...
    function handleClear() {
        props.filterComingSoonMovie({ genre: []});
        setGenre([]);
    }
...
export default ComingSoonMovieFilterModel;