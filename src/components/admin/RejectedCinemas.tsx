                    ...
                    <div className='h-[45%] relative overflow-hidden'>
                        <div className='absolute top-0 left-0 right-0 p-2.5 flex justify-end items-start z-10'>
                            ...
                            <div className='flex items-center gap-1'>
                                ...
                                <button onClick={deleteACinema} data-cinema={cinema._id} className='w-7 h-7 bg-black/50 backdrop-blur-sm rounded-full flex items-center justify-center hover:bg-black/70 transition-colors'>
