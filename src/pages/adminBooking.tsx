        ...
        <div className='bg-[#121212] flex font-[Poppins] overflow-hidden'>
            ...
            <div className='w-full min-h-screen text-white px-7 py-3 pt-7'>
                    ...
                    <div>
                        <div className="flex items-center space-x-3">
                            <span className="bg-gradient-to-r from-red-900 to-red-700 bg-clip-text text-transparent text-[16px] font-medium z-0">
                                <span className='text-[18px] font-medium'>Home {`>`}</span>&nbsp;Booking
                            </span>
                        </div>
                    </div>
                </div>
                ...
                <div className='flex items-center gap-1.5 mt-5'>
                    <Calendar className='w-[23px] h-[23px] text-gray-500' />
                ...
                <div className='grid grid-cols-1  gap-1 mt-3.5 border-gray-800'>
                    ...
                    <div className='rounded-sm bg-[#252525] border-gray-700 w-full grid grid-cols-8 px-5 py-2 mb-1'>
                        <div className='text-[14px] text-white/90'>User</div>
                        <div className='text-[14px] text-white/90'>Booked At</div>
                        <div className='text-[14px] text-white/90'>Cinema</div>
                        <div className='text-[14px] text-white/90'>Screen</div>
                        <div className='text-[14px] text-white/90'>Date</div>
                        <div className='text-[14px] text-white/90'>Time</div>
                        <div className='text-[14px] text-white/90'>Movie</div>
                        <div className='text-[14px] text-white/90'>Ticket</div>
                    </div>

                    <div className='bg-[#252525] border-b border-white/20 w-full grid grid-cols-8 px-5 py-2 pb-2.5'>
                        <div className='text-[13px] text-gray-400'>10998272</div>
                        <div className='text-[13px] text-gray-400'>2025-11-12 11:12:10</div>
                        <div className='text-[13px] text-gray-400'>Skylight</div>
                        <div className='text-[13px] text-gray-400'>Skylight-IMAX</div>
                        <div className='text-[13px] text-gray-400'>11 November 2025</div>
                        <div className='text-[13px] text-gray-400'>1.00 PM</div>
                        <div className='text-[13px] text-gray-400'>Spider Man: No Way Home</div>
                        <div className='text-[13px] text-gray-400'>2</div>
                    </div>
