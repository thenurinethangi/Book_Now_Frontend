...
import cinema1 from '../assets/images/cinema-hall-2.jpg'

function AdminCinemaPending() {
        ...
        <div className='bg-[#121212] flex font-[Poppins] overflow-hidden'>
            ...
            <div className='w-full h-min-screen text-white px-7 py-3 pt-7'>
                ...
                <div className='flex items-center mt-5'>
                    ...
                    <div className='px-2.5 pb-2 opacity-95 text-[18px] border-b-2 border-red-900'>Pending</div>
                ...
                <div className='grid grid-cols-5 gap-[12px] mt-6'>
                    ...
                    <div className='rounded-md bg-[#1e1e1e] h-[350px]'>
                        <div className='h-[45%] relative'>
                            <CircleX className='absolute right-1 top-2.5 text-blue-400 w-5 h-5' />
                            <CircleFadingArrowUp className='absolute right-7.5 top-2.5 text-blue-400 w-5 h-5' />
...
export default AdminCinemaPending