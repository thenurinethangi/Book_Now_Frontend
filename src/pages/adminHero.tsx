...
import { X, Plus, Eye, Trash, Play, Image, Film, Calendar, Edit2 } from "lucide-react";
import SidebarNavigation from '../components/admin/SidebarNavigation';

const heroPostersData = [
    {
        id: 1,
        movieName: "DUNE: PART TWO",
        description: "The saga continues as Paul Atreides unites with Chani and the Fremen",
        status: "Now Showing",
        heroImage: "https://images.unsplash.com/photo-1594908900066-3f47337549d8?w=1200&h=600&fit=crop",
    ...
    },
    {
        ...
        status: "Now Showing",
        heroImage: "https://images.unsplash.com/photo-1635805737707-575885ab0820?w=1200&h=600&fit=crop",
    ...
    },
    {
        ...
        description: "When a killer targets Gotham's elite, Batman must uncover corruption",
        status: "Coming Soon",
...
function AdminHeroPosters() {
    ...
    const [heroPosters, setHeroPosters] = useState(heroPostersData);
    ...
    const handleSubmit = () => {
        ...
        // Handle API call here with FormData
    ...
    const handleDelete = (id) => {
        if (window.confirm('Are you sure you want to delete this hero poster?')) {
            setHeroPosters(heroPosters.filter(p => p.id !== id));
        }
    };
                    ...
                    <div>
                        <div className="flex items-center space-x-3">
                            <span className="bg-gradient-to-r from-red-900 to-red-700 bg-clip-text text-transparent text-[16.5px] font-semibold z-0">
                                <span className='text-[18px] font-medium text-gray-500'>Home {`>`}</span>&nbsp;HeroPoster
                            </span>
                        </div>
                    </div>
                    <button
                            ...
                            <div className='p-4 flex flex-col justify-between'>
                                <div>
                                    <div className='flex justify-between items-start'>
                                        <h3 className='text-[16px] font-medium text-white'>{poster.movieName}</h3>
                                    </div>
                                    ...
                                    <div className='flex gap-4 text-[11px] text-[#666] mt-3'>
                                        ...
                                        <div className='flex items-center gap-1.5'>
                                            ...
                                            <span className={`${poster.status === 'Now Showing' ? 'text-[#02a8b3]' : 'text-gray-400'}`}>{poster.status}</span>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className='bg-[#1a1a1a] rounded-lg w-full max-w-[800px] max-h-[90vh] overflow-y-auto border border-[#2a2a2a]'>
                        ...
                        <div className='sticky top-0 bg-[#1a1a1a] px-5 py-4 border-b border-[#2a2a2a] flex justify-between items-center z-10'>
                            <div>
                                ...
                                <p className='text-[11px] text-[#888] mt-0.5'>Upload hero banner for website homepage</p>
                            </div>
                        ...
                        <div className='p-5'>
                            <div className='space-y-4'>
                                {/* Hero Image Upload */}
                                <div>
                                    <label className='text-[12px] text-[#aaa] mb-2 block'>Hero Image * (1920x800 recommended)</label>
                                    {previewMedia.image ? (
                                        ...
                                        <div>
                                            ...
                                            >
                                                ...
                                                <div className='text-center'>
                                                    <p className='text-[13px] text-[#888]'>Click to upload hero image</p>
                                                    <p className='text-[11px] text-[#666] mt-1'>PNG, JPG up to 10MB</p>
                                                </div>
                                            </label>
                                        </div>
                                    )}
                                ...
                                {/* Video Upload */}
                                <div>
                                    <label className='text-[12px] text-[#aaa] mb-2 block'>Hero Video * (background video)</label>
                                    {previewMedia.video ? (
                                        ...
                                        <div>
                                            ...
                                            >
                                                ...
                                                <div className='text-center'>
                                                    <p className='text-[13px] text-[#888]'>Click to upload video file</p>
                                                    <p className='text-[11px] text-[#666] mt-1'>MP4, WebM up to 50MB</p>
                                                </div>
                                            </label>
                                        </div>
                                    )}
                                ...
                                <div className='grid grid-cols-2 gap-4'>
                                    <div>
                                        <label className='text-[12px] text-[#aaa] mb-1.5 block'>Movie Name *</label>
                                        <select
                                            name="movieName"
                                ...
                                <div>
                                    <label className='text-[12px] text-[#aaa] mb-1.5 block'>Short Description *</label>
                                    <textarea
                                        name="description"
